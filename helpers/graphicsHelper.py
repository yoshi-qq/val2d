...
from config.constants import VIEW_WIDTH, VIEW_HEIGHT, VIEW_ANGLE, ZOOM_IN, HEIGHT_TO_Z_OFFSET, TWO_POINT_FIVE_D
...
def getPoseAndSizeFromPerspective(perspective: Pose, objectPose: Pose, turnable: bool, twoPointFiveD: bool = TWO_POINT_FIVE_D) -> tuple[Pose, float]:
